...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        var url = "https://bollywood-classification-project.onrender.com/classify_image";
        ...
        $.post(url, {
            ...
            */
            ...
            let players = ["shah_rukh_khan", "deepika_padukone", "amitabh_bachchan", "kareena_kapoor", "hrithik_roshan"];
            
            //finds person with highest probability match
            let match = null;
            let bestScore = -1;
